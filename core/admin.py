...
from .models import Index, DicasCategoria, Dica, NoticiasCategoria, Noticia, Associado, Memoria, QuemSomos, NossaHistoria, LinkUtil, Contato, Contribuir, ContribuirItem
